...
namespace ProtoBuf.Meta
{
    ...
    public class MetaType : ISerializerProxy
    {
                ...
                foreach (MemberInfo member in foundList)
            {
                ...
                if((property = member as PropertyInfo) != null)
                {
                    ...
                    if (!property.CanWrite)
                    {
                        ...
                        var backingFieldName = property.Name;//$"<{property.Name}>k__BackingField";
        ...
        private ValueMember AddField(int fieldNumber, string memberName, Type itemType, Type defaultType, object defaultValue)
        {
            ...
            MemberInfo backingField = null;
            PropertyInfo miPropertyInfo = mi as PropertyInfo;
            if (miPropertyInfo.CanWrite == false)
            {
                //var backingMembers = type.GetMember($"<{miPropertyInfo.Name}>k__BackingField", Helpers.IsEnum(type) ? BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
                var backingMembers = type.GetMember(miPropertyInfo.Name, Helpers.IsEnum(type) ? BindingFlags.Static | BindingFlags.Public : BindingFlags.Instance | BindingFlags.Public | BindingFlags.NonPublic);
