 ...
 double ReadDouble()
        ...
        public static void EndSubItem(SubItemToken token, ProtoReader reader)
        {
            ...
            switch (reader.wireType)
            {
                ...
                default:
                    if (value64 < reader.position64) throw reader.CreateException(""); //throw reader.CreateException($"Sub-message not read entirely; expected {value64}, was {reader.position64}");
